  ...
  return (
    <form onSubmit={handleSubmit} noValidate aria-label="Formulario de acceso">
      ...
      <button
        type="button"
        disabled
        className="w-full h-11 flex items-center justify-center gap-3 border border-[#E8ECF4] rounded-xl text-sm font-semibold text-[#566070] bg-[#F4F6FA] cursor-not-allowed mb-4"
      >
